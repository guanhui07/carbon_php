...
class Carbon extends DateTime
{
    ...
    public static function createFromDate($string, $tz = null)
    {
        ...
        return self::create(date('Y',$time),date('m',$time),date('d',$time),date('H',$time),date('i',$time),date('s',$time),$tz);
    }
    ...
    {
        $time = strtotime($string);
        return self::create(date('Y',$time),date('m',$time),date('d',$time),date('H',$time),date('i',$time),date('s',$time));
    }
